...
<div class="container my-5">
    <div class="container d-flex justify-content-center">
        <div class="section-title dark">
           <h2>Création du <span>team</span> welcome</h2>
       </div>
...
<div class="form-row ">
    <input type="text"  value="{{old('title')}}" class="input-text" id="input" name="title" placeholder="Veuillez insérer votre titre de la section svp...">
